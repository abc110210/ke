...
;       栈上 a5..a11 整体下移一格：
;           [rsp+0x20]=a5  [rsp+0x28]=a6  [rsp+0x30]=a7 ... [rsp+0x50]=a11
; ============================================================================
.code
...
NtRawSyscall PROC
    ...
    ; 把栈上 a5..a11 整体下移一格，对齐到 syscall 第 5..11 个参数位置
    mov     r11, [rsp + 030h]
    mov     [rsp + 020h], r11   ; [rsp+0x20] = a5
    mov     r11, [rsp + 038h]
    mov     [rsp + 028h], r11   ; [rsp+0x28] = a6
    mov     r11, [rsp + 040h]
    mov     [rsp + 030h], r11   ; [rsp+0x30] = a7
    mov     r11, [rsp + 048h]
    mov     [rsp + 038h], r11   ; [rsp+0x38] = a8
    mov     r11, [rsp + 050h]
    mov     [rsp + 040h], r11   ; [rsp+0x40] = a9
    mov     r11, [rsp + 058h]
    mov     [rsp + 048h], r11   ; [rsp+0x48] = a10
    mov     r11, [rsp + 060h]
    mov     [rsp + 050h], r11   ; [rsp+0x50] = a11
    syscall
    ret
NtRawSyscall ENDP
